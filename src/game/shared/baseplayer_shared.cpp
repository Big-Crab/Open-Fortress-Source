...
#ifdef CLIENT_DLL
ConVar mp_usehwmmodels( "mp_usehwmmodels", "0", NULL, "DISABLED, DOES NOTHING. Enable the use of the hw morph models. (-1 = never, 1 = always, 0 = based upon GPU)" ); // -1 = never, 0 = if hasfastvertextextures, 1 = always
#endif
...
// https://github.com/ValveSoftware/source-sdk-2013/pull/313
#if defined( OF_DLL ) || defined ( OF_CLIENT_DLL )

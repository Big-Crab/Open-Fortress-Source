...
if not "%dynamic_shaders%" == "1" goto SkipDynamic
...
goto PSDone
:SkipDynamic
powershell -NoLogo -ExecutionPolicy Bypass -Command "%SrcDirBase%\devtools\bin\process_shaders.ps1 -Version %SHVER% '%inputbase%.txt'"
:PSDone
